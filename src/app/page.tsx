      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          <header className="text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs tracking-wide text-black/60 shadow-sm backdrop-blur">
              RIFT REPORT <span className="h-1 w-1 rounded-full bg-white/30" /> Personal League analytics
            </div>
